...
This paper also contributes and extends previous work in survey-based schematic class analysis by attempting to validate the results of the resulting schema partitions using behavioral criteria linked to the domain in question (in this case, patterns of musical listening choices). I showed that we can leverage techniques developed for the analysis of correlation networks to go beyond eyeballing \citep{epskamp2012qgraph,networktools}. In particular, I showed that a simple measure of vertex centrality referred to as ``expected influence'' \citep{robinaugh2016identifying}, does a good job of capturing the genres most central in each schema. The validation results reveal two sets of notable findings. 
